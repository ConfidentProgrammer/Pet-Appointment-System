          ...
          <div className="pet-item col media py-3" key={item.aptId}>
            ...
            <div className="pet-info media-body">
              ...
              <div className="owner-name">
                <span className="label-item" contentEditable suppressContentEditableWarning onBlur={ e=> this.props.updateInfo('ownerName', e.target.innerText, item.aptId)}>{item.owner}</span>
